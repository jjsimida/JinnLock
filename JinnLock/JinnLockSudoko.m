...
- (void)setup
{
    ...
    self.circleMargin = JINN_LOCK_SUDOKO_SIDE_LENGTH / 15;
}
...
- (void)createCircles
{
    for (int i = 0; i < 9; i++)
    {
        ...
        [circle setTag:JINN_LOCK_SUDOKO_LEVEL_BASE + i];
...
- (void)drawRect:(CGRect)rect
{
    ...
    self.errorPassword ? [JINN_LOCK_COLOR_ERROR set] : [JINN_LOCK_COLOR_NORMAL set];
